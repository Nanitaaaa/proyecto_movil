...
class TicketCancelledScreen extends StatefulWidget {
  const TicketCancelledScreen({Key? key}) : super(key: key);

  @override
  _TicketCancelledScreenState createState() => _TicketCancelledScreenState();
}

class _TicketCancelledScreenState extends State<TicketCancelledScreen> {
  ...
  Future<void> _loadTickets() async {
    ...
    try {
      tickets = await RestServiceTickets.getAllTickets('CANCELLED');
