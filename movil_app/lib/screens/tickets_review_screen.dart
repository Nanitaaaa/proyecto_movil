...
class TicketsReviewScreen extends StatefulWidget {
  const TicketsReviewScreen({Key? key}) : super(key: key);

  @override
  _TicketsReviewScreenState createState() => _TicketsReviewScreenState();
}

class _TicketsReviewScreenState extends State<TicketsReviewScreen> {
