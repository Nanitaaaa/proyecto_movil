...
class TicketsResolvedScreen extends StatefulWidget {
  const TicketsResolvedScreen({Key? key}) : super(key: key);

  @override
  _TicketsResolvedScreenState createState() => _TicketsResolvedScreenState();
}

class _TicketsResolvedScreenState extends State<TicketsResolvedScreen> {
  ...
  Future<void> _loadTickets() async {
    try {
      tickets = await RestServiceTickets.getAllTickets('RESOLVED');
