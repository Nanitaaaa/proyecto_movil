...
class TicketsProgressScreen extends StatefulWidget {
  const TicketsProgressScreen({Key? key}) : super(key: key);

  @override
  _TicketsProgressScreenState createState() => _TicketsProgressScreenState();
}

class _TicketsProgressScreenState extends State<TicketsProgressScreen> {
